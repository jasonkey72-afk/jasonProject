...
ACTIONS = {
    ...
    "wait_new_tab": {"label": "새 탭 열릴 때까지 기다렸다가 이동", "group": "웹", "need_target": False, "value_label": "제목/주소 일부(비워도 됨)"},
    "switch_tab":   {"label": "탭 전환",             "group": "웹", "need_target": False, "value_label": "탭 번호(-1=마지막) 또는 제목/주소 일부"},
